...
public:
  ...
  void preparePipelines()
  {
    ...
    shaderStages[0] = loadShader(VikAssets::getShaderPath() + "hmddistortion/distortion.vert.spv", VK_SHADER_STAGE_VERTEX_BIT);
    shaderStages[1] = loadShader(VikAssets::getShaderPath() + "hmddistortion/distortion.frag.spv", VK_SHADER_STAGE_FRAGMENT_BIT);
    ...
    // Offscreen pipeline
    shaderStages[0] = loadShader(VikAssets::getShaderPath() + "hmddistortion/diffuse-pass.vert.spv", VK_SHADER_STAGE_VERTEX_BIT);
    shaderStages[1] = loadShader(VikAssets::getShaderPath() + "hmddistortion/diffuse-pass.frag.spv", VK_SHADER_STAGE_FRAGMENT_BIT);
