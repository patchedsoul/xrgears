...
public:
  ...
  void preparePipelines()
  {
    ...
    pipelineCreateInfo.layout = hmdDistortion->pipelineLayout;
    VK_CHECK_RESULT(vkCreateGraphicsPipelines(device, pipelineCache, 1, &pipelineCreateInfo, nullptr, &hmdDistortion->pipeline));
