...
public:
  ...
  void preparePipelines()
  {
    ...
    shaderStages[0] = VikShader::load(device, VikAssets::getShaderPath() + "hmddistortion/distortion.vert.spv", VK_SHADER_STAGE_VERTEX_BIT);
    shaderModules.push_back(shaderStages[0].module);

    shaderStages[1] = VikShader::load(device, VikAssets::getShaderPath() + "hmddistortion/distortion.frag.spv", VK_SHADER_STAGE_FRAGMENT_BIT);
    ...
    // Offscreen pipeline
    shaderStages[0] = VikShader::load(device, VikAssets::getShaderPath() + "hmddistortion/diffuse-pass.vert.spv", VK_SHADER_STAGE_VERTEX_BIT);
    shaderModules.push_back(shaderStages[0].module);

    shaderStages[1] = VikShader::load(device, VikAssets::getShaderPath() + "hmddistortion/diffuse-pass.frag.spv", VK_SHADER_STAGE_FRAGMENT_BIT);
    shaderModules.push_back(shaderStages[1].module);
