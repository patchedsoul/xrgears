...
void
VikRenderer::init_vk(const char *extension)
{
...
VkFormat
VikRenderer::choose_surface_format()
{
...
void
VikRenderer::init_vk_objects(Cube * model)
{
...
void
VikRenderer::init_buffer(struct vkcube_buffer *b)
{
