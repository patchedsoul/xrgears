...
bool
CubeApplication::display_mode_from_string(const char *s)
{
    if (streq(s, "auto")) {
	mode = DISPLAY_MODE_AUTO;
	return true;
...
void
CubeApplication::parse_args(int argc, char *argv[])
{
