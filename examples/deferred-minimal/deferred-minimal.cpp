...
public:
  ...
  */
  ...
  void preparePipelines()
  {
    ...
    shaderStages[0] = loadShader(getAssetPath() + "shaders/openhmd-distortion/distortion.vert.spv", VK_SHADER_STAGE_VERTEX_BIT);
    shaderStages[1] = loadShader(getAssetPath() + "shaders/openhmd-distortion/distortion.frag.spv", VK_SHADER_STAGE_FRAGMENT_BIT);
    ...
    // Offscreen pipeline
    shaderStages[0] = loadShader(getAssetPath() + "shaders/deferred/mrt-shade.vert.spv", VK_SHADER_STAGE_VERTEX_BIT);
    shaderStages[1] = loadShader(getAssetPath() + "shaders/deferred/mrt-shade.frag.spv", VK_SHADER_STAGE_FRAGMENT_BIT);
